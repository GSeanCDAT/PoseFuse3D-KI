...
from diffusers.models.resnet import ResnetBlock2D, AlphaBlender
from diffusers.models.activations import get_activation


class CasualTemporalResnetBlock(nn.Module):
    r"""
    A Resnet block.
    ...
    def __init__(
        ...
        self.time_causal_padding = (0, 0, 0, 0, 2, 0)
...
# VideoResBlock
class CasualSpatioTemporalResBlock(nn.Module):
    r"""
    ...
    def __init__(
        ...
        self.temporal_res_block = CasualTemporalResnetBlock(
